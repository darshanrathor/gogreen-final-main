...
export default function PlantGaneshaSlug() {
                ...
                <div className="flex flex-col gap-5">
                  ...
                  <div className="flex flex-col mt-5">
                    ...
                    <div className="flex flex-col gap-4 pb-7 mt-5">
                      ...
                      target="_blank"
                      rel="noreferrer"
                      href={`https://api.whatsapp.com/send?phone=919137606826?text=I%20want%20to%20book%20this%20ganesha%20Eco%20friendly%20${product?.name}%20-${product?.inch}"Inch%20Thank%20you!`}
