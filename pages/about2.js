          ...
          <div className=" bg-zinc-100 mt-6 max-w-[800px] rounded-xl p-3  ">
            <div className="w-full mx-auto ">
              <div className="flex flex-col text-center justify-center items-center">
                <h1 className="text-center text-xl lg:text-3xl text-[#184029] font-heading font-bold">
                  {" "}
                ...
                <div className="flex flex-row-1 text-center justify-center items-center mt-3">
                  ...
                  <Image
                    src="/icons/herbal-spa-treatment-leaves.png"
                    width={15}
                    height={15}
        ...
        <div className="p-9 gap-y-5 ">
          ...
          <div className="itmes-center text-center font-heading flex flex-col lg:flex lg:flex-row mt-[40px] justify-center">
            <figure className="snip1139">
              ...
              <img
                src="/img/WhatsApp Image 2022-06-11 at 9.50.09 PM.jpeg"
                alt=""
              />
