        ...
        <div className={`fixed flex justify-between flex-col bg-[#184029]  z-30 top-0 left-0 w-full h-full transition-all duration-200 ease-linear ${transition}`}>
            <div className=" pt-5 flex flex-col gap-5">
                ...
                <div className="flex divide-y px-5 divide-green-900 flex-col">
                    <Navlink onclick={passclose} text="Clay ganesha" link="/clay-ganesha" />
            ...
            <div className="bg-[#A2F578] h-[50px] ">

            <div className="flex mt-2 items-center justify-start gap-x-8 w-full">
							<Link href="https://api.whatsapp.com/send?phone=918169882692">
								<a className="">
									<div className="bg-white ] rounded-full w-10 h-10 flex justify-center items-center   duration-200">
										<svg
											className="fill-black group-hover:fill-white fill-black w-6 h-6 "
											id="Layer_1"
											version="1.1"
							...
							<Link href="https://www.instagram.com/gogreenganesha/">
								<a className="">
									<div className=" ] bg-white rounded-full w-10 h-10 flex justify-center items-center  duration-200">
										<svg viewBox="0 0 1024 1024" className="fill-black">
							...
							>
								<a className="">
									<div className="bg-white ] rounded-full w-10 h-10 flex justify-center items-center duration-200">
										<svg
											className="group  fill-black  w-6 h-6"
...
const Navlink = ({ text, link, onclick }) => {
    return (
        <Link href={link}>
            <a onClick={onclick} className="capitalize  hover:text-[#E6FCE0] py-3.5 text-zinc-200 font-semibold text-2xl duration-100 ease-in">
                {text}
            </a>
        </Link>
    )
