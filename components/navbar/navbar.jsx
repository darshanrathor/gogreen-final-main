      ...
      >
        <div className="flex w-full  items-center gap-10 justify-between max-w-7xl mx-auto px-5 ">
          ...
          <div className="hidden md:flex gap-7 justify-center items-center w-full">
            <Navlink text="EcoFriendly clay ganesha" link="/clay-ganesha" />
            {/*<Navlink text="paper ganesha" link="/paper-ganesha" />*/}
            <Navlink text="EcoFriendly plant ganesha" link="/plant-ganesha" />
          ...
          <div className="flex   items-center">
            ...
            <button
              className="text-white relative flex gap-1 items-center px-2 sm:px-6 mr-5 hover:text-zinc-300"
