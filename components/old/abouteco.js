...
const arr = ["100% ECO-FRIENDLY IDOLS","NATURAL COLORS/CHEMICAL ARE USED","STRONGER THAN NON/OTHER ECO-FRIENDLY IDOLS","EASSY TO CARRY","EASILY DISSOLVABLE IN WATER","PROMOTING GREEN CITY"];
